    ...
    <header className="header absolute left-0 right-0 top-0 z-50 ~h-32/48 ~px-4/6 ~py-4/6 md:h-32">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-[auto,auto] items-center gap-6 md:grid-cols-[1fr,auto,1fr]">
        ...
        <nav
          ...
          className="col-span-full row-start-2 md:col-span-1 md:col-start-2 md:row-span-1"
        >
        ...
        <div className="justify-self-end">
          <ButtonLink href="" icon="cart" color="purple" aria-label="Cart (0)">
            <span className="md:hidden">0</span>
            <span className="max-md:hidden">Cart (0)</span>
          </ButtonLink>
        </div>
      </div>
    </header>
